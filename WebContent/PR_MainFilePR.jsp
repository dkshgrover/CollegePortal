...
<%@page import="servelets.PR_checkEmail"%>
...
<body>
	...
	boolean bool = PR_checkEmail.check(email);
	if (!bool) {
	...
	<nav
		...
		<div class="collapse navbar-collapse" id="navbarNavDropdown">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link" href="#et">INFRASTRUCTURE</a></li>
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> Pay/Fee Info. </a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="PR_studentInfo.jsp">STUDENTS
							INFO.</a>
						<div class="dropdown-divider"></div>
						<a style="text-align: left" class="dropdown-item"
							href="PR_teacherInfo.jsp">TEACHER INFO.</a>
					</div></li>
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="PR_changepass.jsp">Change
							Password</a>
						<div class="dropdown-divider"></div>
						<a style="text-align: left" class="dropdown-item"
							href="PR_logoutservlet">Logout</a>
					</div></li>
