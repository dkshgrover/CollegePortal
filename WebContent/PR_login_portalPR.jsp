...
<title>PAYROLL's LOGIN PORTAL!!</title>
<link rel="stylesheet"
...
<body>
	...
	<img src="photos/acc.png" class="center" width="250px">
	<br>
	<form action="PR_compayroll" method="post" autocomplete="off">
		<div class="form-group">
			<label for="email" class="mar">Email address</label> <input
				type="email" class="mar form-control" id="email" name="email"
				aria-describedby="emailHelp" placeholder="Enter email" required>
			<small id="emailHelp" class="mar form-text text-muted">We'll
