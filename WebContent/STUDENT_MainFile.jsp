...
<%@page import="servelets.STUDENT_checkEmail"%>
<!DOCTYPE html>
<html>
<head>
<link rel="stylesheet"
...
<body>
	...
	boolean bool = STUDENT_checkEmail.check(uname,course);
	if (!bool) {
	...
	<nav
		...
		<div class="collapse navbar-collapse" id="navbarNavDropdown">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link" href="STUDENT_showRecordsServlet">SHOW RECORDS</a></li>
				<li class="nav-item"><a class="nav-link" href="STUDENT_event.jsp">EVENTS</a></li>				
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<hr>
						<a class="dropdown-item" href="#"><%=uname%></a> <a
							class="dropdown-item" href="STUDENT_aboutme.jsp">About Me</a> <a
							class="dropdown-item" href="STUDENT_changepass.jsp">Change
							Password</a>
						<div class="dropdown-divider"></div>
						<a style="text-align: left" class="dropdown-item"
							href="STUDENT_logoutservlet">Logout</a>
					</div></li>
	...
	<div id="carouselExampleCaptions" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="carousel-item active" data-interval="5000">
				<img src="photos/student1.jpg" class="d-block" alt="FIRST SLIDE"
			...
			<div class="carousel-item" data-interval="5000">
				<img src="photos/student2.jpg" class="d-block" alt="SECOND SLIDE"
					style="margin-left: 5%; width: 90%; height: 450px; opacity: 0.6;">
				<div class="carousel-caption d-none d-md-block">
					<h3
			...
			<div class="carousel-item" data-interval="5000">
				<img src="photos/student3.jpg" class="d-block" alt="THIRD SLIDE"
					style="margin-left: 5%; width: 90%; height: 450px; opacity: 0.6;">
				<div class="carousel-caption d-none d-md-block">
					<h3
						style="color: black; background-color: white; margin-left: 35%; margin-right: 35%;">
			...
			<div class="carousel-item" data-interval="5000">
				<img src="photos/student4.jpg" class="d-block" alt="FOURTH SLIDE"
					style="margin-left: 5%; width: 90%; height: 450px; opacity: 0.6;">
				<div class="carousel-caption d-none d-md-block">
					<h3
						style="color: black; background-color: white; margin-left: 35%; margin-right: 35%;">
			...
			<div class="carousel-item" data-interval="5000">
				<img src="photos/student5.jpg" class="d-block" alt="FOURTH SLIDE"
					style="margin-left: 5%; width: 90%; height: 450px; opacity: 0.6;">
				<div class="carousel-caption d-none d-md-block">
					<h3
						style="color: black; background-color: white; margin-left: 35%; margin-right: 35%;">
