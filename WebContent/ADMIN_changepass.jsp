...
<%
	...
	<br>
	<br>
	<form class="mar" action="ADMIN_changepassservlet" method="post"
		autocomplete="off">
		...
		<p style="color:red;"><%= request.getAttribute("errm")==null?"":request.getAttribute("errm") %></p>
		<div class="form-group">
		...
		<p style="color:red;"><%= request.getAttribute("errm2")==null?"":request.getAttribute("errm2") %></p>
		<br>
		<div class="form-group">
