...
<body>
	...
	<br>
	<br>
	<form class="mar" action="PR_updateservlet" method="post"
		autocomplete="off">
		ROLL NO:<br> <input type="text" name="roll" required>
		<span style="color: red;"><%=request.getAttribute("ERRM") == null ? "" : request.getAttribute("ERRM")%></span><br><br>
		<label for="status">Enter Choice Please-</label> <select
