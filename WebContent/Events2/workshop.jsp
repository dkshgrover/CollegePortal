...
<body>
	...
	<br>
	<p>
		<img class="cl" src="../photos/workshop.png" width=714px height=254px
			style="margin-left: 5%"> <b style="margin-left: 2%;">Start
			Date :</b><br> <i style="margin-left: 2%;">20 Aug 2020</i><br>
	...
	<p class="mar1">Robert Bosch & Department of Mechanical
	...
	<p class="mar1">Robert Bosch conduct workshop on i) Advancements in
		Braking system ii) Design and Simulation of Brakes An Expo on Brake
		components</p>
</body>
</html>