 ...
 */
@WebServlet("/PR_updateservlet4")
public class PR_updateservlet4 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (count == 1) {
				...
				request.getRequestDispatcher("PR_updateDetailsFINE.jsp").forward(request, response);
			}
